...
angular.module('loadDisplay').value('loadTemplate',  "<div id='load-background' class='hide-background'>" +    "<div class='loading-display'>"+      "<img src='Resources/images/ajax-loader.gif' height='60' width='60'><br><span>Loading</span></div>"+    "</div>"+  "</div>");